...
const CategoryShowcase = () => {
  const [items, setItemsData] = useState(ProductData);

  const filterItem = (cate) => {
    const updatedProducts = ProductData.filter((curElem) => curElem.cate === cate);
    setItemsData(updatedProducts);
  };
  return (
      ...
      <div className="container">
        ...
        <div className="section-header">
          ...
          <div className="course-filter-group">
            <ul className="lab-ul">
              <li onClick={() => setItemsData(ProductData)}>All</li>
